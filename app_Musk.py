...
async def on_chat_start():
    ...
    # Prompt for Trade bot
    prompt_template = """Analyze Elon Musk's tweets in the context for mentions of Dogecoin. If a tweet expresses strong support for Dogecoin, respond with 'YES' and send an API call to Trading Robot_Doge. If the tweet is related to Dogecoin but doesn't express strong support, send an email to leeywin@gmail.com."
